...
There are `dim(stationsRW)[1]` stations with valid coordinates within the Reading/Wokingham Urban Area (blue circles), but hourly data is available only for `length(IDstationHdata)` of them  and their location is shown in the map below (red circle).
