...
## ----hourlydata, eval = TRUE, fig.width=7--------------------------------
...
## ----dotchart1, eval=TRUE, fig.height = 10, fig.width=7------------------
# Zone
dotchart(as.matrix(table(stations$Zone))[,1])

## ----dotchart2, eval=TRUE, fig.width=7-----------------------------------
# Environment.Type
